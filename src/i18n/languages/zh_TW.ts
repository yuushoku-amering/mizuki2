...
export const zh_TW: Translation = {
	...
	[Key.games]: "遊戲經驗",
	[Key.gamesTitle]: "遊戲經驗",
	[Key.gamesSubtitle]: "競技 · 二遊 · 單機 · 手遊 · 頁遊",
	[Key.gamesTotalPlaytime]: "總遊玩時長",
	[Key.gamesTotalSpending]: "總課金",
	[Key.gamesTotalCount]: "收錄遊戲",
	[Key.gamesProficient]: "精通遊戲",
	[Key.gamesProficientGames]: "較精通",
	[Key.gamesProficientBadge]: "精通",
	[Key.gamesPlatform]: "平台",
	[Key.gamesPlaytime]: "時長",
	[Key.gamesSpending]: "課金",
	[Key.gamesFilterAll]: "全部",
	[Key.gamesPrimaryCompetitive]: "競技",
	[Key.gamesPrimaryGacha]: "二遊",
...
[Key.gamesSecondaryMoba]: "MOBA",
	[Key.gamesSecondaryBattleroyale]: "大逃殺",
	[Key.gamesSecondaryFighting]: "格鬥",
	[Key.gamesSecondaryOpenWorld]: "開放世界",
	[Key.gamesSecondaryAction]: "動作",
	[Key.gamesSecondaryRpg]: "RPG",
	[Key.gamesSecondarySimulation]: "模擬/沙盒",
	[Key.gamesSecondaryRhythm]: "音遊",
	[Key.gamesSecondaryVisualNovel]: "視覺小說",
