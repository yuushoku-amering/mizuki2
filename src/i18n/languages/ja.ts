...
export const ja: Translation = {
	...
	[Key.gamesSubtitle]: "競技 · ガチャ · ソロ · モバイル · ブラウザ",
	...
	[Key.gamesPrimaryCompetitive]: "競技",
	[Key.gamesPrimaryGacha]: "ガチャ",
...
[Key.gamesSecondaryMoba]: "MOBA",
	[Key.gamesSecondaryBattleroyale]: "バトロワ",
	[Key.gamesSecondaryFighting]: "格闘",
	[Key.gamesSecondaryOpenWorld]: "オープンワールド",
	[Key.gamesSecondaryAction]: "アクション",
	[Key.gamesSecondaryRpg]: "RPG",
	[Key.gamesSecondarySimulation]: "シミュレーション",
	[Key.gamesSecondaryRhythm]: "音ゲー",
	[Key.gamesSecondaryVisualNovel]: "ビジュアルノベル",
