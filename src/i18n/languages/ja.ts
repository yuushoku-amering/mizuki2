...
export const ja: Translation = {
	...
	// ゲーム経験ページ
	[Key.games]: "ゲーム経験",
	[Key.gamesTitle]: "ゲーム経験",
	[Key.gamesSubtitle]: "ソロ · 競技 · ガチャ · ブラウザ · モバイル",
	[Key.gamesTotalPlaytime]: "総プレイ時間",
	[Key.gamesTotalSpending]: "総課金額",
	[Key.gamesTotalCount]: "収録ゲーム",
	[Key.gamesProficient]: "得意なゲーム",
	[Key.gamesProficientGames]: "得意",
	[Key.gamesProficientBadge]: "得意",
	[Key.gamesPlatform]: "プラットフォーム",
	[Key.gamesPlaytime]: "プレイ時間",
	[Key.gamesSpending]: "課金",
	[Key.gamesFilterAll]: "すべて",
	[Key.gamesCategorySingleplayer]: "ソロゲーム",
	[Key.gamesCategoryCompetitive]: "競技ゲーム",
	[Key.gamesCategoryGacha]: "ガチャゲーム",
	[Key.gamesCategoryBrowser]: "ブラウザ",
	[Key.gamesCategoryMobile]: "モバイル",
};
