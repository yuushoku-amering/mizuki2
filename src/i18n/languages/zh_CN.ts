...
export const zh_CN: Translation = {
	...
	// 番剧页面
	[Key.animeTitle]: "喜欢的作品",
	[Key.animeSubtitle]: "动漫 / 漫画 / 轻小说 / 小说",
	[Key.animeStatusWatching]: "动漫",
	[Key.animeStatusCompleted]: "漫画",
	[Key.animeStatusPlanned]: "轻小说",
	[Key.animeStatusOnHold]: "小说",
	[Key.animeStatusDropped]: "",
	[Key.animeFilterAll]: "全部",
	[Key.animeYear]: "年份",
	[Key.animeStudio]: "作者 / 制作",
	[Key.animeEmpty]: "暂无作品数据",
	[Key.animeEmptyBangumi]: "请检查 Bangumi 配置或网络连接",
	[Key.animeEmptyBilibili]: "请检查 Bilibili 配置或网络连接",
	[Key.animeEmptyLocal]: "请在 src/data/anime.ts 文件中添加喜欢的作品",
	...
	[Key.games]: "游戏经验",
	[Key.gamesTitle]: "游戏经验",
	[Key.gamesSubtitle]: "竞技 · 二游 · 单机 · 手游 · 页游",
	[Key.gamesTotalPlaytime]: "总游玩时长",
	[Key.gamesTotalSpending]: "总氪金",
	[Key.gamesTotalCount]: "收录游戏",
	[Key.gamesProficient]: "精通游戏",
	[Key.gamesProficientGames]: "较精通",
	[Key.gamesProficientBadge]: "精通",
	[Key.gamesPlatform]: "平台",
	[Key.gamesPlaytime]: "时长",
	[Key.gamesSpending]: "氪金",
	[Key.gamesFilterAll]: "全部",
	[Key.gamesPrimaryCompetitive]: "竞技",
	[Key.gamesPrimaryGacha]: "二游",
	[Key.gamesPrimarySingleplayer]: "单机",
	[Key.gamesPrimaryMobile]: "手游",
	[Key.gamesPrimaryBrowser]: "页游",
	[Key.gamesPrimaryFeatured]: "主要游玩/较喜欢",
[Key.gamesSecondaryFps]: "FPS",
[Key.gamesSecondaryTps]: "TPS",
[Key.gamesSecondaryMoba]: "MOBA",
	[Key.gamesSecondaryBattleroyale]: "大逃杀",
	[Key.gamesSecondaryFighting]: "格斗",
	[Key.gamesSecondaryOpenWorld]: "开放世界",
	[Key.gamesSecondaryAction]: "动作",
	[Key.gamesSecondaryRpg]: "RPG",
	[Key.gamesSecondarySimulation]: "模拟/沙盒",
	[Key.gamesSecondaryRhythm]: "音游",
	[Key.gamesSecondaryVisualNovel]: "视觉小说",
	[Key.gamesSecondaryStrategy]: "策略",
	[Key.gamesSecondaryCard]: "卡牌",
	[Key.gamesSecondaryTpsGacha]: "TPS",
	[Key.gamesDeveloper]: "厂商",
	[Key.gamesReleaseDate]: "发行",
	[Key.gamesExperience]: "游戏经历",
	[Key.gamesFeaturedNote]: "鉴于具体游玩过的游戏较多，在此仅选择部分代表性作品罗列",
};
